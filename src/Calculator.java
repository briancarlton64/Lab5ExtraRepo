...
public class Calculator
{
    ...
    protected static int calculateTwoTokens(String[] tokens) throws NumberFormatException, CalculatorException
    {
        ...
        switch(tokens[0])
        {
        	case "halve": a = a/2; break;
        	case "negate": a = -a; break;
    ...
    protected static int execute(String[] tokens) throws NumberFormatException, CalculatorException
    {
        ...
        {
        case 1: switch(tokens[0]) {case "quit": return Integer.MIN_VALUE;  default: throw new CalculatorException("Illegal Command"); }
        case 2: a = Calculator.calculateTwoTokens(tokens); break;
        case 3: a = Calculator.calculateThreeTokens(tokens); break;
    ...
    public static String parseAndExecute(String input)
    {
    	...
    	try {
    	a= Calculator.execute(tokens);
    	if(a== Integer.MIN_VALUE)
    	{
    		return "quit";
    	}
    	out = ("The result is: " + Integer.toString(a));
    	}
    	catch(CalculatorException e){
    		out = ("Calculator Exception, message is: " +e.getMessage());
    	}
    	catch(ArithmeticException ab)
    	{
    		out = ("Attempted to divide by 0. Please try again.");
    	}
    	catch(NumberFormatException f)
    	{
    		out = ("Input number cannot be parsed to an int. Please try again.");
    	}
    	return out;
    }
}
